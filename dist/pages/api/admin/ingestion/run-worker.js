...
const ingestionWorker_1 = __importDefault(require("../../../../lib/workers/ingestionWorker"));
async function handler(req, res) {
    ...
    ingestionWorker_1.default.runIngestionWorker().then(() => console.log('worker finished')).catch(err => console.error('worker failed', err));
