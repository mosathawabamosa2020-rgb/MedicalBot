...
"[project]/medical-content-platform/pages/api/health/database.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$medical$2d$content$2d$platform$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].$queryRaw`SELECT 1`;
        return res.status(200).json({
            status: 'ok'
        });
    } catch (err) {
        __TURBOPACK__imported__module__$5b$project$5d2f$medical$2d$content$2d$platform$2f$lib$2f$logger$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].error(err, 'database health check failed');
        return res.status(503).json({
            status: 'error'
        });
    } finally{
        await __TURBOPACK__imported__module__$5b$project$5d2f$medical$2d$content$2d$platform$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].$disconnect();
    }
}
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__28177abc._.js.map