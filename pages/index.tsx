...
export default function PortalHome() {
  ...
  return (
    <Layout>
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-4">منصة المعرفة الطبية</h1>
        <p className="text-gray-600">ابحث في المحتوى الطبي الموثق من مصادر متعددة</p>
      </div>

      <section className="mb-10 rounded-lg border bg-gradient-to-br from-blue-50 to-white p-6">
      ...
      <section className="mb-10">
        <h2 className="mb-3 text-xl font-semibold">المراجع المميزة</h2>
        <div className="grid gap-3 md:grid-cols-2">
          {featured.map((ref) => (
            <a key={ref.id} href={`/reference/${ref.id}`} className="rounded-lg border bg-white p-6 hover:shadow-lg transition-shadow">
      ...
      <section>
        <h2 className="mb-3 text-xl font-semibold">المراجع الحديثة</h2>
